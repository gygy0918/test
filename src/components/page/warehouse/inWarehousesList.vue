<template>
    <div class="table">
        ...
        <el-table :data="warehouseIn" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            ...
            <!--</el-table-column>-->
            <el-table-column prop="yhId" label="入库人编号" width="120">
            </el-table-column>
        ...
        <el-dialog title="修改入库信息" :visible.sync="dialogFormVisible">
            <el-form :model="form" ref="form">
                <el-form-item label="入库人编号" :label-width="formLabelWidth">
...
//            this.getData();
            this.$ajax(
                {
                    method: 'get', //请求方式
                    url: 'http://10.103.243.94:8080/warehouseIn/page',
                    params:{
                        page:1,
                        size:5
                    },
                ...
                console.log('结果',this.warehouseIn)
            })
        },
        computed: {
            data(){
